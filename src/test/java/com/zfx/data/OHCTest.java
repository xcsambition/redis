...
public class OHCTest {
    public static void main(String[] args) {
        OHCache<String, String> stringOHCache = OHCacheBuilder.<String, String>newBuilder()
                .keySerializer(new StringSerializer())
                .valueSerializer(new StringSerializer())
                .eviction(Eviction.LRU)
                .build();
        System.out.println(stringOHCache.getClass());
        stringOHCache.put("hello","world");
        System.out.println(stringOHCache.get("hello"));
    }
